...
class AutomationAIPython:
    def __init__(self):
        self.stats = {'keywords_generated': 0, 'comments_generated': 0, 'fallbacks_used': 0, 'errors': 0}
    ...
    def get_fallback_keyword(self, persona: Optional[Dict] = None) -> Dict:
        ...
        return {'keyword': random.choice(FALLBACK_KEYWORDS[category]), 'source': 'fallback',
                'category': category, 'persona': persona.get('id') if persona else None}
