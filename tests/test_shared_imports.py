...
class TestSharedImports:
    ...
    def test_import_supabase_client(self):
        ...
        from shared import HAS_SUPABASE, DeviceSync, JobSync, get_client
...
class TestSchemaValidation:
    ...
    def test_device_create(self):
        ...
        device = DeviceCreate(serial_number="R3CM40TEST1", pc_id="PC-01", model="Galaxy S9")
    ...
    def test_task_create(self):
        ...
        task = TaskCreate(video_id="test-video-123", priority=8)
...
class TestPatternConfig:
    ...
    def test_watch_pattern_config(self):
        ...
        config = WatchPatternConfig(
            min_watch_seconds=30, full_watch_probability=0.2, seek_enabled=False
        )
