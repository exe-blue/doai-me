...
import { createEconomyContent } from '../actions';
      ...
      <div className="space-y-4">
        {filteredContents.length === 0 ? (
          ...
          filteredContents.map((content) => (
            <EconomyCard key={content.id} content={content} />
          ))
        )}
      </div>
    </div>
...
function EconomyCard({ content }: { content: EconomyContent }) {
  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
          <label className="block text-neutral-400 text-xs mb-1">Total Reward</label>
          <input
            name="total_reward"
            type="number"
            min="1"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label className="block text-neutral-400 text-xs mb-1">Open At</label>
          <input
            name="open_at"
            type="datetime-local"
            required
        ...
        <div>
          <label className="block text-neutral-400 text-xs mb-1">Max Participants (optional)</label>
          <input
